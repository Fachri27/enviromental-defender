            ...
            <table class="min-w-full text-sm text-left text-gray-700">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="px-4 py-3 font-medium text-gray-500">Deskripsi (ID)</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-gray-700 capitalize truncate max-w-xs">{!! $resource->deskripsi !!}
                        </td>
                        ...
                        <td class="px-4 py-3 text-right">
                            ...
                            <button wire:click='destroy({{ $resource->id }})'
                                class="text-red-600 hover:underline text-sm font-medium ml-2">Delete</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
